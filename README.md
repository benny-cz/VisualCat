...
> **Status:** `2.0.7` is the current stable release. Download the checksummed,
...
VisualCat `2.0.7` is available from the
...
```shell
dotnet tool install --global VisualCat.Cli --version 2.0.7 --add-source ./packages
```
