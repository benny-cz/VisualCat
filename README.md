...
> **Status:** `2.0.3` is the current stable release. Download the checksummed,
...
VisualCat `2.0.3` is available from the
...
```shell
dotnet tool install --global VisualCat.Cli --version 2.0.3 --add-source ./packages
```
