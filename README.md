...
> **Status:** `2.0.12` is the current stable release. Download the checksummed,
...
VisualCat `2.0.12` is available from the
...
```shell
dotnet tool install --global VisualCat.Cli --version 2.0.12 --add-source ./packages
```
