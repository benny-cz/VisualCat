...
> **Status:** `2.0.5` is the current stable release. Download the checksummed,
...
VisualCat `2.0.5` is available from the
...
```shell
dotnet tool install --global VisualCat.Cli --version 2.0.5 --add-source ./packages
```
