...
> **Status:** `2.0.8` is the current stable release. Download the checksummed,
...
VisualCat `2.0.8` is available from the
...
```shell
dotnet tool install --global VisualCat.Cli --version 2.0.8 --add-source ./packages
```
